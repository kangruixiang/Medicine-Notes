...
1. ↓ Cardiac output—e.g. **CHF** (**congestive heart failure**), **cardiogenic shock**
2. NSAIDs (**↓ PGI2 → ↓ vasodilation of afferent arteriole → ↓ GFR**) or ACE inhibitors (↓ angiotensin II → ↓ vasoconstriction of efferent arteriole → ↓ GFR) can precipitate prerenal failure in patients who already have poor renal perfusion.
