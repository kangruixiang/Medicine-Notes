...
Three categories of upper airway obstruction may be defined on the basis of the flowvolume loop: 1) fixed obstruction, 2) variable intra-thoracic obstruction, and 3) variable extrathoracic obstruction (you need to know these).
...
Paradoxically, NaHCO3 should _not_ be given in cases of pure respiratory acidosis. The HCO3combines with H+ in tissue, forming CO2 and H2O. If ventilation is not fixed, the **CO2 cannot be exhaled**, and the **hypercapnea worsens**.
